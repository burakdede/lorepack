import type { BuildId, BuildManifest, BuildScope } from '@lorepack/core';
...
class FakeD1Database implements D1DatabaseLike, D1QueryDatabaseLike, D1CatalogDatabaseLike {
